...
function RedirectionJavascriptVersIndex(){
    document.location.href="http://localhost/Projet/ChoixCombattants.php"; 
}
...
let pokeJoueur = document.getElementById('pokeJoueur');
console.log(pokeJoueur);
if (monPokemon.name_pokemon) {

    let url = "http://localhost/Projet/Images/Gifs/combat";
    let urlFin = ".png";
    // console.log(url+monPokemon.name_pokemon+urlFin);

    // selectImg.src = url+monPokemon.name_pokemon+urlFin;

    pokeJoueur.src = url+monPokemon.name_pokemon+urlFin;
}

// Creation du Pokemon adverse en dur //
...
let pokeAdversaire = document.getElementById('pokeAdversaire');
console.log(pokeAdversaire);
if (pokeAdv.name_pokemon) {

    let url = "http://localhost/Projet/Images/Gifs/combat";
    let urlFin = ".png";

    pokeAdversaire.src = url+pokeAdv.name_pokemon+urlFin;
}
...
let nomAdv = document.querySelector('.nomAdv');
nomPoke.innerHTML = monPokemon.name_pokemon;
nomAdv.innerHTML = pokeAdv.name_pokemon;
